        ...
        .then(products => {
            ...
            if (!products.length) {
                container.innerHTML = `<div class="col-12 text-center py-5">
                    ...
                    <p class="text-secondary">No one if logged in
                const custName  = CustomerSession.isLoggedIn() ? CustomerSespavers available in the catalog currently.</p></div>`;
                return;
            }
            products.forEach(p => {
                ...
                // Pre-fill customer name/phsion.name()  : "";
